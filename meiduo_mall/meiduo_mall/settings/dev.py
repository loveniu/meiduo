...
SECRET_KEY = 'ennvwmto-@hq_-or0o28z(-^if_-5+c7fk+f72=41*-e2=h1@='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# 在开发模式，django默认只支持127.0.0.1的域名访问，如果有其他域名访问，需要进行配置
...
INSTALLED_APPS = [
    ...
    'payment.apps.PaymentConfig',  # 订单应用
    'xadmin',
    'crispy_forms',
    'reversion',
]
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = 'qiwanheng_zte@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'qwe123456'
# 收件人看到的发件人
EMAIL_FROM = '美多商城<qiwanheng_zte@163.com>'
...
FDFS_BASE_URL = 'http://192.168.187.135:8888/'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.187.135:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
...
# django_redis配置解码
# DJANGO_REDIS_CONNECTION_FACTORY = "meiduo_mall.utils.redis_decode.ConnectionFactory"