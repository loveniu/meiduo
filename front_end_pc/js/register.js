var vm = new Vue({
    ...
    mounted: function () {
        ...
        // axios.get('http://127.0.0.1:8000/images/'+this.image_code_id)
        // 	.then => {
        //
        // }
            ...
            if (this.error_name == false && this.error_password == false && this.error_check_password == false
                ...
                axios.post(this.host + '/users/', {
                    ...
                    .then(response => {
                        ...
                        localStorage.user_id = response.data.id; //对应后端响应中的id字段
                    ...
                    .catch(error => {
                        ...
                        if (error.response.status == 400) {
                            if ('non_field_errors' in error.response.data) {
                                this.error_sms_code_message = '短信验证码有误';
